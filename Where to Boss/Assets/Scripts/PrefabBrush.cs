...
[CustomGridBrush(hideAssetInstances:false, hideDefaultInstance:false, defaultBrush:false,defaultName:"Prefab Brush")]
...
public class PrefabBrush : GameObjectBrush
{
    ...
    private static Transform GetObjectInCell(GridLayout grid, Transform parent, Vector3Int position)
    {
        ...
        Bounds bounds = new Bounds(min + max * 0.05f, max - min);
